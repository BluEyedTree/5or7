...
#24/40 Is the current accuracy of the logistic regression
...
#24/40 Same Results as before. Adding a hundred columns to the left and right does not work. 
#This was not the most intelligent approach because the high number of variables was the problem, so adding more would probably not help
...
#24/40, back to the original result

#Scaling Doesn't seem to work, sigh....

#Blame the model, not the coder
